...
import { Plus, Building2, Home, Users, Trash2, Pencil, X, UserCircle, User, Phone, MapPin, Briefcase, Heart, AlertCircle, FileText } from "lucide-react";
...
export default function Household() {
  ...
  const [activeTab, setActiveTab] = useState("personal"); // For tabbed interface in member form
